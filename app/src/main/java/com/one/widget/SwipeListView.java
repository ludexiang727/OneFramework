...
public class SwipeListView extends ListView implements AbsListView.OnScrollListener, SwipeRefreshLayout.OnRefreshListener, AdapterView.OnItemClickListener  {
  ...
  public SwipeListView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    mFooterView = LayoutInflater.from(context).inflate(R.layout.list_view_footer_layout, null);
    mProgress = (ProgressBar) mFooterView.findViewById(R.id.list_footer_progress);
    mFooterInfo = (TextView) mFooterView.findViewById(R.id.list_footer_info);
